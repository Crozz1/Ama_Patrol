package com.ama_patrol.presentation.menu.locator.finder.view.activities
...
import com.ama_patrol.presentation.menu.locator.finder.view.adapter.MainAdapter
import com.ama_patrol.presentation.menu.locator.finder.viewmodel.MainViewModel
...
import kotlinx.android.synthetic.main.locator_.*
...
class MainActivity(val REQ_PERMISSION: Any?) : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.locator_)
    ...
    private fun getLocationViewModel() {
            mainViewModel = ViewModelProvider(this, NewInstanceFactory())[MainViewModel::class.java]
    ...
    private fun getMarker(modelResultsArrayList: ArrayList<ModelResults>) {
        ...
        mapsView.setOnMarkerClickListener { marker ->
            ...
            for (i in modelResultsArrayList.indices) {
                if (markerPosition.latitude == modelResultsArrayList[i].lat &&
                    markerPosition.longitude == modelResultsArrayList[i].lng) {
                    markerSelected = i
                }
            }
